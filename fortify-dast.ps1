...
$responseurl = 'http://' + $url_scdast_api + '/api/scans/start-scan-cicd'
...
$StatusUrl = 'http://' + $url_scdast_api + '/api/v2/scans/' + $scanId + '/scan-summary'
$ScanCompleted = "5"
$ScanStopped = "3"
$ScanInterrupted = "6"
$ScanFailed = "10"
...
if ($ScanStatus -eq $ScanCompleted){
    ...
    $fprurl = 'http://' + $url_scdast_api + '/api/v2/scans/' + $scanId + '/download-fpr'
    ...
    $PublishUrl = 'http://' + $url_scdast_api + '/api/v2/scans/' + $scanId + '/scan-action'
